...
class BubbleSort(Scene):
    def construct(self):
     ...
     #  self.play(Write(texiterno[0]))
        ...
        self.play(Create(intiterno6))  # next_to(texiteration, RIGHT)
       ...
       # self.play(numa.become(numb))
        ...
        self.play(Transform(intiterno6, intiterno2))
      ...
      # intiterno = intiterno.increment_value(1.0)
       ...
       # for i in range(1,7) :
        ...
        self.play(rect.animate.shift(RIGHT))
          ...
          # transform iteration value
        self.play(Transform(intiterno6, intiterno3))
        ...
        self.play(rect.animate.shift(RIGHT))
          ...
          # transform iteration value
        self.play(Transform(intiterno6, intiterno4))
        ...
        self.play(rect.animate.shift(RIGHT))
          ...
          # transform iteration value
        self.play(Transform(intiterno6, intiterno5))
        ...
        self.play(Transform(rect, rect2))
          ...
          # transform iteration value
        self.play(Transform(intiterno6, intitern6))
       ...
       # circlef+=numf2
        ...
        self.play(intiterno6.animate.next_to(intpassno1,DOWN*5))
